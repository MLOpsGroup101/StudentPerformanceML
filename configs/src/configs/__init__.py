...
class DataConfig:
    ...
    dropped_columns: list[str] = field(default_factory=lambda: ["student_id", "age", "gender", "uses_ai", "ai_tools_used", "ai_usage_purpose", "ai_dependency_score", "ai_prompts_per_week", "ai_ethics_score", "last_exam_score", "assignment_scores_avg", "concept_understanding_score", "study_consistency_index", "improvement_rate", "tutoring_hours", "class_participation_score", "passed", "performance_category"])
