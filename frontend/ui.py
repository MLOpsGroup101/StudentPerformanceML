...
with st.form("prediction_form"):
    ...
    grade_level = st.selectbox(
        "Grade Level", 
        ["10th", "11th", "12th", "1st Year", "2nd Year", "3rd Year"]
    )
    ...
    ai_content_pct = st.slider(
        "AI Generated Content in Work (%)", 
        0, 100, 20, 
        help="Percentage of submitted work generated by AI"
    ) / 100.0
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if prediction > 85:
                ...
                st.write("👍 Good job, but there is room for improvement.")
            else:
                st.write("⚠️ Warning: You might want to adjust your study habits.")
        else:
